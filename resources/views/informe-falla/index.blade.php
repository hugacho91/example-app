                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive min-vh-100">
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                ...
                                <tbody>
                                @forelse ($informeFallas as $informeFalla)
                                    <tr>
                                        <td><input class="form-check-input m-0 align-middle" type="checkbox"
                                                   aria-label="Select informeFalla"></td>
                                        <td>{{ ++$i }}</td>
                                        
											<td>{{ $informeFalla->fecha }}</td>
											<td>{{ $informeFalla->empleado }}</td>
											<td>{{ $informeFalla->empleador }}</td>
											<td>{{ $informeFalla->estado }}</td>
                       ...
                       <div class="card-footer d-flex align-items-center">
                            {!! $informeFallas->links('tablar::pagination') !!}
                        </div>
                    </div>
                </div>
            </div>
